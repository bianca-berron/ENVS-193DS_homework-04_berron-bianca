...
Normal Q-Q plot: looking at the qqplot, the residuals look normally distributed, as the residuals follow linear path. 
...
Residuals vs leverage plot: there doesn't appear to be any significant residual outliers that are affecting the model predictions. 
